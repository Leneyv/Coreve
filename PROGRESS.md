...
## PHASE 3 — PRODUCT PAGE REBUILD (Part 7–9)

- [ ] Above-the-fold: photography, name, price, short benefit line, size selector, Size Guide link, Add to Bag, Buy Now
- [ ] Below-fold accordion/sections: Why She'll Love It / Product Design / Fit & Comfort / Materials / Care / Delivery (real timelines) / Size Exchange (real 7-day policy) / FAQ
- [ ] Tighten Refab copy to match the real conditions (Queens Club membership + registration + 6–12 month window), not the current unconditional phrasing
- [ ] Editorial gallery reorder per Part 8 sequence (hero/side/top/sole/on-foot/detail/scale) where source images allow; lazy-load below the fold, reserve dimensions
- [ ] Mobile sticky buy bar (product/price/size/buy), hides when cart drawer or checkout is active
